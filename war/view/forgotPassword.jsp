...
<html lang="en">
	<head>
    	...
    	<title>Forgot password | GetmyRoomie.com</title>
          			...
          			<div class="tab-pane active">
            			...
            			<div class="alert alert-danger alert-dismissable display-none" id="ajaxError">
			           	...
			           	<div class="pageheading row">
			         		...
			         		<div class="clearfix">
			           			<h3>Don't worry! Fill in your email address and get right back on track!</h3>
			         		</div>
			       		</div>


              			<form action="/recoverPassword" class="forgot-password-form" id="forgotPasswordForm" method="POST">
                			<div class="form-group">
                  				<input type="email" class="form-control new-input-field-minimz form-recovery-email" id="userEmail" name="userEmail" placeholder="Enter email you signed up with">
                			</div>
                			<button type="submit" class="btn btn-primary" id="passwordRecoveryButton" style="font-size: 15px;">Reset password</button>
              			</form>
          			</div>
        		</div>
      		</div>
