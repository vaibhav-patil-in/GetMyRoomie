...
<html lang="en">
	<head>
  	...
  	<body>
				...
				<div id="jumbotron" style="padding-top: 0px;">
					...
					<div class="row" id="searchrow">
						<div class="col-sm-1 search-panel-city">
	                		<div class="form-group">
	                        	<select class="form-control" id="browseRoomMateLookingInCity" name="browseRoomMateLookingInCity">
						...
						<div class="col-sm-2 col-lg-3 search-panel">
	            			<fieldset>
	              				<div class="search-group">
	                				<input type="text" placeholder="Search by area in ur city..." value="${roommate.lookingforArea}" autocomplete="off" class="form-control" id="browseRoomMateLocation" name="browseRoomMateLocation">
	              				</div>
	            			</fieldset>
	          			</div>
		          		...
		          		<div class="col-sm-2 search-panel">
							<div class="form-group">
	                    		<div id="gender" class="btn-group" data-toggle="buttons">
	                      			<label class="btn btn-default btn-input"><input type="radio" name="browseRoomMateUserGender" id="Male" value="Male"> Male</label>
	                  				<label class="btn btn-default btn-input"><input type="radio" name="browseRoomMateUserGender" id="Female" value="Female"> Female</label>
	                      		</div>
	                  		</div>
		          		</div>
		          		...
		          		<div class="col-sm-2 search-panel">
							<div class="form-group">
	                    		<div id="gender" class="btn-group" data-toggle="buttons">
	                      			<label class="btn btn-default btn-input"><input type="radio" name="browseRoomMateUserOccupation" id="Male" value="Professional"> Professional</label>
	                  				<label class="btn btn-default btn-input"><input type="radio" name="browseRoomMateUserOccupation" id="Female" value="Student"> Student</label>
	                      		</div>
	                  		</div>
		          		</div>
			          	...
			          	<div class="col-sm-2 search-panel">
		                	<div class="form-group">
		                        <select class="form-control" id="browseRoomMateMonthlyBudget" name="browseRoomMateMonthlyBudget">
		                        	<option value="-">Monthly Budget</option>
		                        	<option value="Less than -2000">Less than Rs 2000</option>
					                ...
					                <option value="Greater than -6000">Greater than Rs 6000</option>
		              			</select>
		                	</div>
			          	</div>
	            	...
	            	<div id="jumbotronRight" style="width: 100%">
						...
						<div id="gridView" class="row">
							...
							<c:if test="${myMateListingList == null}">
	            				<h5>No roommates found for your search. Would you like to <a href="/browseRoomMates">Browse all Roommates</a></h5>
	            			</c:if>
		...
		<script type="text/javascript">
			function initialize() {
    			var input = document.getElementById('browseRoomMateLocation');
